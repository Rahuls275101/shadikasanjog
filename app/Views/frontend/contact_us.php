                            ...
                            <ul>
                                <li>
                                    <div class="we-here">
                                        ...
                                        <span><i class="fa fa-phone" aria-hidden="true"></i> +91-8882826172</span>
                                        <span><i class="fa fa-envelope-o" aria-hidden="true"></i>
                                            shadikasanjog@gmail.com</span>
                                        <span><i class="fa fa-map-marker" aria-hidden="true"></i> Noida</span>
                                    </div>
                                </li>
                        ...
                        <div class="rhs">
                            <div>
                                <div class="form-tit">
                                    ...
                                    <h1>Got a Query? Let me help. </h1>
                                </div>
                                <div class="form-login">
                                    <form class="cform fvali" method="post" id="contactForms">
                                        
                                                        <input type="hidden" id="lable" name="lable" value="Contact Form">
