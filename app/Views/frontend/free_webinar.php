...
<!-- 
                <div class="row  justify-content-center">
                    ...
                    <div class="col-md-10">
                        <p>    Free webinar to explain the unique features of our website shadikasanjog.com to
                            both our existing new members and those interested in registering with us is held
                            every Saturday from 5:00 to 5:30 PM. If you are desirous to attend the webinar, you
                            need to register on Free Webinar section of the website. We will get in touch with
                            you for the needful.</p>
                    </div>
                ...
                <div class="row justify-content-center">
                   ...
                   <div class="col-md-8 col-lg-8 col-sm-12">
                    ...
                    <div class="shadow-sm p-2 p-md-5">
                        ...
                        <div class="form-login">
                            <form class="cform fvali" method="post" id="contactForms">
                                   <input type="hidden" id="lable" name="lable" value="Free Webinar">
